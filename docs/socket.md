...
This is the deliberate half of the story. The *involuntary* half — Chromium
...
| Command                               | Params           | Effect / result                                        |
| ------------------------------------- | ---------------- | ------------------------------------------------------ |
| `navigate`                            | `url`, `newTab?`, `background?` | load a (normalized) url; `newTab:true` opens a new tab, `background:true` (with `newTab`) loads it hidden without switching to it |
...
| `focus-app`            | —             | bring Mira to the foreground. **The only command that does** — every other one leaves the user's foreground app alone (see **Foreground** above)                                                                        |
