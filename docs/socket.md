...
| Command                                  | Params                | Effect / result                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| ---------------------------------------- | --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `list-tabs`                              | `windowId?`           | `{tabs, activeId, panelCollapsed}` — tabs of the target window, with their UUID ids. With `windowId` (from `list-windows`), lists that window instead and echoes it back; errors: `unknown window: <id>`                                                                                                                                                                                                                                                                  |
