...
| `focus-address-bar`                   | —                                         | put keyboard focus on the address bar with its contents selected (Cmd+L, menu File → Open Location…). On the error page the bar holds the URL that FAILED, so Enter re-navigates to it                                                                                                                                                                                                                                                    |
...
| `copy-active-url`                        | —                     | copy the active tab's url to the OS clipboard and flash a "Copied!" toast. Also what focusing the address bar fires. `{url}`. Errors: `no url to copy` (nothing active, or no url yet)                                                                                                                                                                                                                                                                                    |
